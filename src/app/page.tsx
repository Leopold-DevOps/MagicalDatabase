  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      <div className="w-full max-w-2xl">
        <p className="mb-4 text-[11px] font-medium uppercase tracking-[0.4em] text-ink-100 [text-shadow:_0_1px_10px_rgba(0,0,0,0.9)]">
          A grimoire for planeswalkers
        </p>

        <h1 className="font-display text-6xl leading-[1.02] tracking-tight text-ink-50 [text-shadow:_0_2px_24px_rgba(0,0,0,0.85)] md:text-7xl">
          <span className="title-glow">Magical</span>
          <span className="block text-ink-50">Database</span>
        </h1>

        <p className="mx-auto mt-5 max-w-md text-balance text-sm font-medium text-ink-100 [text-shadow:_0_1px_10px_rgba(0,0,0,0.95)]">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-2 text-xs">
          <span className="font-medium text-ink-200 [text-shadow:_0_1px_8px_rgba(0,0,0,0.9)]">
            Try
          </span>
        ...
        <nav className="mt-8 flex items-center justify-center gap-6 text-sm font-medium text-ink-200 [text-shadow:_0_1px_8px_rgba(0,0,0,0.9)]">
